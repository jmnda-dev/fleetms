defmodule Fleetms.Service.ServiceGroupSchedule do
  use Ash.Resource,
  ...
  relationships do
    ...
    many_to_many :service_tasks, Fleetms.Service.ServiceTask do
      through Fleetms.Service.ServiceGroupScheduleServiceTask
  ...
  policies do
    ...
    policy action(:create) do
      ...
      authorize_if accessing_from(Fleetms.Service.ServiceGroup, :service_group_schedules)
    end
