defmodule Fleetms.Service.ServiceGroup do
  use Ash.Resource,
  ...
  relationships do
    has_many :service_group_schedules, Fleetms.Service.ServiceGroupSchedule

    many_to_many :vehicles, Fleetms.Vehicles.Vehicle do
      domain Fleetms.Vehicles
      through Fleetms.Service.ServiceGroupVehicle
          ...
          if is_list(service_group_schedules) and service_group_schedules != [] do
            schedule_params =
              Enum.reduce(service_group_schedules, [], fn schedule, acc ->
                reminder_params =
                  Fleetms.Service.ServiceGroupSchedule.bulk_service_reminders_attrs(
                    schedule,
