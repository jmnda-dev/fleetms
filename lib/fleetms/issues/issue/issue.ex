defmodule Fleetms.Issues.Issue do
  use Ash.Resource,
  ...
  relationships do
    ...
    has_many :issue_photos, Fleetms.Issues.IssuePhoto
  end
  ...
  actions do
    ...
    create :create do
      ...
      change Fleetms.Issues.Issue.Changes.SetIssueNumber do
  ...
  policies do
    ...
    policy action([
      ...
      authorize_if accessing_from(Fleetms.Service.WorkOrder, :issues)
    end
