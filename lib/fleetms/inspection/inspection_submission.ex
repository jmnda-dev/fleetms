defmodule Fleetms.Inspection.InspectionSubmission do
  use Ash.Resource,
  ...
  relationships do
    ...
    has_many :radio_input_values, Fleetms.Inspection.RadioInputValue
    has_many :dropdown_input_values, Fleetms.Inspection.DropdownInputValue
    has_many :number_input_values, Fleetms.Inspection.NumberInputValue
    has_many :signature_input_values, Fleetms.Inspection.SignatureInputValue
    has_many :text_input_values, Fleetms.Inspection.TextInputValue
  end
