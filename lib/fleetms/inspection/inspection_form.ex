defmodule Fleetms.Inspection.InspectionForm do
  use Ash.Resource,
  ...
  relationships do
    has_many :inspection_submissions, Fleetms.Inspection.InspectionSubmission

    many_to_many :vehicles, Fleetms.Vehicles.Vehicle do
      domain Fleetms.Vehicles
      through Fleetms.Inspection.InspectionFormVehicle
      source_attribute_on_join_resource :inspection_form_id
      destination_attribute_on_join_resource :vehicle_id
    end

    has_many :radio_inputs, Fleetms.Inspection.Form.RadioInput
    has_many :dropdown_inputs, Fleetms.Inspection.Form.DropdownInput
    has_many :number_inputs, Fleetms.Inspection.Form.NumberInput
    has_many :signature_inputs, Fleetms.Inspection.Form.SignatureInput
    has_many :text_inputs, Fleetms.Inspection.Form.TextInput
  end
